...
vid = "13fb"
pid = "eafd"
output_dir = "system_chunks"  
start_sector = 100480  # **** ATTENTION -> THIS HAS TO BE CHANGED ACCORDING TO YOUR PARTITION TABLE ****
total_sectors = 30592  # **** ATTENTION -> THIS HAS TO BE CHANGED ACCORDING TO YOUR PARTITION TABLE ****
...
def run_edl_command(start_sector, num_sectors, chunk_index):
    output_file = f"{output_dir}/system_chunk{chunk_index}.bin"
